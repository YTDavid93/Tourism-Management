                ...
                <div class="card-body">
                  <form class="form-sample"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                     ...
                     <div class="form-group col-md-6 pl-md-0">
                      <label class="col-sm-12 pl-0 pr-0">Package Price in RS</label>
                      <div class="col-sm-12 pl-0 pr-0">
                  ...
                  <div class="row">
                    <div class="form-group col-md-6 pl-md-0">
                      ...
                      <div class="col-sm-12 pl-0 pr-0">
                        <textarea class="form-control" rows="5" cols="50" name="packagedetails" id="packagedetails" placeholder="Package Features Eg-free Pickup-drop facility" required></textarea> 
                      </div>
                    </div>
                    <div class="form-group col-md-6">
                      <label class="col-sm-12 pl-0 pr-0">Package Details</label>
                      <div class="col-sm-12 pl-0 pr-0">
                        <input type="text" class="form-control" name="packagefeatures" id="packagefeatures" placeholder="Package Details" required>
                      </div>
                    </div>
                  </div>
